	...
	<div id="sidebar">
		<ul id="mainNav">
			<li id="navDashboard" class="nav" style="cursor:pointer;"
				...
				class="icon-home"></span> <a>管理Project</a></li>
			<li id="navDashboard" class="nav" style="cursor:pointer;"
				onclick='changeIframe("frame", "<%=path%>/managerLogout.html");'><span
				class="icon-home"></span> <a>注销</a></li>
		</ul>
	</div>
	<div id="content">
		<iframe id="frame" src="" height="790px" width="1000px"></iframe>
	</div>
</body>
</html>